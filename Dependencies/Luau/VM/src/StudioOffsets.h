...
namespace RBX::Studio::Offsets {
    ...
    static std::uintptr_t luau_execute = RebaseAddress(0x1431c30b0);
    ...
    static std::uintptr_t pseudo2addr = RebaseAddress(0x1431b6750);
    ...
    static std::uintptr_t rluaE_newthread = RebaseAddress(0x1431b7c40);
    ...
    static std::uintptr_t rLuaD_throw = RebaseAddress(0x1431ba650);
    ...
    static std::uintptr_t rlua_newthread = RebaseAddress(0x1431b46c0);

    // search for "defer"
    static std::uintptr_t rTask_defer = RebaseAddress(0x141e2df80);
    ...
    static std::uintptr_t rFreeBlock = RebaseAddress(0x1431d1200);
    ...
    static std::uintptr_t rFromLuaState = RebaseAddress(0x141c6b350);
    ...
    static std::uintptr_t rLuaD_rawrununprotected = RebaseAddress(0x1431ba400);
    ...
    static std::uintptr_t rLuaC_Step = RebaseAddress(0x1431cead0);

    // search for "ProximityPrompt_Triggered".
    static std::uintptr_t fireproximityprompt = RebaseAddress(0x14260fd70);

    // search for "InvalidInstance". Caller with two arguments (Modifies lua stack)
    static std::uintptr_t pushinstance = RebaseAddress(0x141d2b770);
