...
const std::vector<std::string> disallowed_extensions = {
        ".exe",     ".bat",    ".com",     ".cmd",      ".inf", ".ipa",      ".apk",         ".apkm",   ".osx",
        ".pif",     ".run",    ".wsh",     ".bin",      ".app", ".vb",       ".vbs",         ".scr",    ".fap",
        ".cpl",     ".inf1",   ".ins",     ".inx",      ".isu", ".job",      ".lnk",         ".msi",    ".ps1",
        ".reg",     ".vbe",    ".js",      ".x86",      ".pif", ".xlm",      ".scpt",        ".out",    ".ba_",
        ".jar",     ".ahk",    ".xbe",     ".0xe",      ".u3p", ".bms",      ".jse",         ".cpl",    ".ex",
        ".osx",     ".rar",    ".zip",     ".7z",       ".py",  ".cpp",      ".cs",          ".prx",    ".tar",
        ".",        ".wim",    ".htm",     ".html",     ".css", ".appimage", ".applescript", ".x86_64", ".x64_64",
        ".autorun", ".tmp",    ".sys",     ".dat",      ".ini", ".pol",      ".vbscript",    ".gadget", ".workflow",
        ".script",  ".action", ".command", ".arscript", ".psc1"};
...
std::string GetLocation() {
    ...
    GetModuleFileNameA(GetModuleHandleA("Module.dll"), DllPath, _countof(DllPath));
...
void FilesystemLibrary::register_environment(lua_State *L) {
    ...
    static const luaL_Reg reg[] = {
            {"readfile", readfile},     {"listfiles", listfiles}, {"writefile", writefile}, {"makefolder", makefolder},
            {"appendfile", appendfile}, {"delfile", delfile},     {"delfolder", delfolder}, {"isfile", isfile},
            {"isfolder", isfolder},     {"dofile", dofile},       {"loadfile", loadfile},   {nullptr, nullptr},
    };
